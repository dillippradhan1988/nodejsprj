...
function renderHomePage(req, res) {
    var serverName          =   process.env.VCAP_APP_HOST ? process.env.VCAP_APP_HOST + ":" + process.env.VCAP_APP_PORT : 'localhost:8080';
    ...
    req.session.regenerate(function (err) {
        ...
        res.render('chat/index', { title:'Express', server:serverName, user:req.session.user});
    });
}
